    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        <Card
          ...
          description="Once we agree on the plan, I cue my lofi playlist and dive into coding. From initial sketchs to polished code, I keep you updated every step of the way."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          description="This is where the magic happens.Based on the approved design , I'll translate everything into function code, building your website from the ground up"
        >
          <CanvasRevealEffect
            animationSpeed={3}
